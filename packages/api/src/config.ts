...
const configSchema = z.object({
  ...
  ASK_BAILEY_TRANSCRIPTION_BASE_URL: z.string().default(""),
  ASK_BAILEY_TRANSCRIPTION_API_KEY: z.string().default(""),
  ASK_BAILEY_TRANSCRIPTION_MODEL: z.string().default(""),
  ASK_BAILEY_TRANSCRIPTION_TIMEOUT_MS: z.coerce.number().int().min(5000).max(600000).default(120000),
