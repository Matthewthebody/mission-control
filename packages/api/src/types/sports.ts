...
export const SPORTS_STAFFING_STATUSES = [
  "unassigned",
  "partially_staffed",
  "staffed",
  "checked_in",
...
export const SPORTS_INVOICE_PAYMENT_STATUSES = [
  "not_required",
  "pending",
  "estimated",
  "invoiced",
...
export type SportsInvoicePaymentStatus = (typeof SPORTS_INVOICE_PAYMENT_STATUSES)[number];
...
export type SportsShootListResponse = {
  ...
  permissions: SportsPermissionSnapshot;
  saved_views: Array<{ key: string; label: string; hash: string; active: boolean }>;
  summary: {
    total: number;
    at_risk: number;
...
export type SportsProofCycleRecord = {
  ...
  status: SportsProofStatus | string;
  sent_at: string | null;
...
export type SportsFinancialSummaryRecord = {
  ...
  invoice_status: SportsInvoicePaymentStatus | string;
  ...
  payment_status: SportsInvoicePaymentStatus | string;
  notes: string | null;
  created_at: string;
  updated_at: string;
};
...
export type SportsWatchFlagRecord = {
  ...
  organization_id: string | null;
  organization_name: string | null;
  severity: SportsRiskStatus | string;
  flag_type: string;
  title: string;
  description: string | null;
  status: SportsWatchFlagStatus | string;
...
export type SportsProductionItemSummary = {
  ...
  status: SportsProductionStatus | string;
  assigned_to_user_id: string | null;
  assigned_to_name: string | null;
  due_date: string | null;
