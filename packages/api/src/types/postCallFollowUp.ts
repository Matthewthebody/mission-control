import type { TeamsMeetingLinkedObjectType, TeamsMeetingStatus } from "./teamsMeetings.js";
import type { WorkTaskStatus } from "../domain/jobTruth/index.js";
import type { JobWatchFlagSeverity, JobWatchFlagStatus } from "../domain/jobTruth/index.js";
...
export type PostCallOutcomeSummary = {
...
export type PostCallFollowUpView = {
  ...
  summary: PostCallOutcomeSummary;
...
export type CreatePostCallOutcomeInput = {
  ...
  notes?: string | null;
  reason_for_call?: string | null;
  mark_handled?: boolean | null;
  create_follow_up_task?: boolean | null;
  follow_up_task_title?: string | null;
  follow_up_task_assignee_user_id?: string | null;
  follow_up_task_due_at?: string | null;
  flag_issue?: boolean | null;
  issue_severity?: JobWatchFlagSeverity | null;
