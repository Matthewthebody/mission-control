import type {
  ...
  CentralJobReadinessStatus,
  CentralJobRecordState,
  CentralJobRequestSource,
  CentralJobStatus
} from "../domain/centralJobIntake/index.js";
import type { OrganizationAccountType } from "./organizations.js";
...
export type CentralJobRouteField =
  | "department"
  | "job_type"
  | "job_title"
  | "source_reference"
  ...
  | "raw_source_text"
  | "school_detail.student_count_estimate"
  | "school_detail.staff_count_estimate"
  | "school_detail.camera_count_estimate"
  | "school_detail.background_requirements"
  | "school_detail.school_day_notes"
  | "school_detail.building_instructions"
  | "school_detail.photo_day_special_notes"
  | "school_detail.school_job_type"
  | "school_detail.roster_status"
  | "school_detail.id_sort_method"
  | "school_detail.yearbook_due_date"
  | "sports_detail.team_count_estimate"
  | "sports_detail.athlete_count_estimate"
  | "sports_detail.coach_count_estimate"
  | "sports_detail.uniform_notes"
  | "sports_detail.sponsor_notes"
  | "sports_detail.event_notes"
  | "sports_detail.on_site_sales_notes"
...
export interface CentralJobNormalizedSchoolDetail {
  school_job_type: string | null;
  school_type: string | null;
  student_count_estimate: number | null;
  staff_count_estimate: number | null;
...
export interface CentralJobNormalizedSportsDetail {
  sports_job_type: string | null;
  sport_name: string | null;
  season: string | null;
  level_or_age_group: string | null;
...
export interface CentralJobNormalizedPayload {
  department: CentralJobDepartment | null;
  job_type: CentralJobCanonicalJobType | null;
  job_title: string | null;
  request_source: CentralJobRequestSource;
  ...
  raw_source_text: string | null;
  duplicate_override_note: string | null;
  days: CentralJobNormalizedDay[];
  school_detail: CentralJobNormalizedSchoolDetail;
  sports_detail: CentralJobNormalizedSportsDetail;
}

export interface CentralJobNormalizedDay {
  day_index: number;
  shoot_date: string | null;
  start_time: string | null;
  end_time: string | null;
...
export interface CentralJobSanitizedPatchResult {
  patch: CentralJobIntakeInput;
  blocked_fields: CentralJobRouteField[];
...
export interface CentralJobReadinessItemRecord {
  id: string;
  tenant_id: string;
  shoot_id: string;
  code: string;
...
export interface CentralJobImportRowRecord {
  id: string;
  tenant_id: string;
  import_session_id: string;
  row_number: number;
  raw_payload: Record<string, unknown>;
  normalized_payload: CentralJobIntakeInput | null;
  status: string;
