...
const rawDashboardWidgetDefinitions: Record<DashboardWidgetId, DashboardWidgetDefinitionInput> = {
  ...
  "field-exceptions": {
    ...
    destinationHash: "#needs-attention",
...
export const DASHBOARD_QUICK_ACTIONS: Record<DashboardQuickActionId, DashboardQuickActionDefinition> = {
  ...
  "view-field-exceptions": { id: "view-field-exceptions", label: "View Needs Attention", description: "Open the shared review queue for field execution problems.", hash: "#needs-attention", supportedRoles: ["shoot_lead"], requiredCapabilities: ["review_desk.view"] },
  ...
  "review-escalations": { id: "review-escalations", label: "Review Escalations", description: "Open follow-up and escalation context tied to support work.", hash: "#needs-attention", supportedRoles: ["customer_service_staff"], requiredCapabilities: ["review_desk.view"] },
  ...
  "resolve-exception": { id: "resolve-exception", label: "Open Needs Attention", description: "Open the shared review queue for items needing leadership follow-up.", hash: "#needs-attention", supportedRoles: ["manager", "leadership"], requiredCapabilities: ["review_desk.view"] },
  ...
  "check-major-exceptions": { id: "check-major-exceptions", label: "Check Needs Attention", description: "Open major workflow pressure and review-required items.", hash: "#needs-attention", supportedRoles: ["leadership"], requiredCapabilities: ["review_desk.view"] },
