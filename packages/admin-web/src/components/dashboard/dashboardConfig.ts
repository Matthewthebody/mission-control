...
const rawDashboardWidgetDefinitions: Record<DashboardWidgetId, DashboardWidgetDefinitionInput> = {
  ...
  "field-exceptions": {
    ...
    destinationHash: "#employees/compliance",
...
export const DASHBOARD_QUICK_ACTIONS: Record<DashboardQuickActionId, DashboardQuickActionDefinition> = {
  ...
  "view-field-exceptions": { id: "view-field-exceptions", label: "View Exceptions", description: "Open the compliance workspace for field execution problems.", hash: "#employees/compliance", supportedRoles: ["shoot_lead"], requiredCapabilities: ["review_desk.view"] },
  ...
  "review-escalations": { id: "review-escalations", label: "Review Escalations", description: "Open follow-up and escalation context tied to support work.", hash: "#employees/compliance", supportedRoles: ["customer_service_staff"], requiredCapabilities: ["review_desk.view"] },
  ...
  "resolve-exception": { id: "resolve-exception", label: "Resolve Exception", description: "Open the compliance workspace for shared exception review.", hash: "#employees/compliance", supportedRoles: ["manager", "leadership"], requiredCapabilities: ["review_desk.view"] },
  ...
  "check-major-exceptions": { id: "check-major-exceptions", label: "Check Exceptions", description: "Open major workflow and compliance pressure.", hash: "#employees/compliance", supportedRoles: ["leadership"], requiredCapabilities: ["review_desk.view"] },
