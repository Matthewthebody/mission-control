...
export const DASHBOARD_WIDGET_CONTENT_SPECS: Record<DashboardWidgetId, DashboardWidgetContentSpec> = {
  ...
  "field-exceptions": {
    ...
    primaryCta: { label: "Open Photography Prep", hash: "#studios/pre-service" },
    emptyState: {
    ...
    errorState: {
      ...
      action: { label: "Retry" },
      secondaryAction: { label: "Open Photography Prep", hash: "#studios/pre-service" }
    },
  ...
  "manager-workflow": {
    ...
    secondaryCta: { label: "Open Project Tracking", hash: "#project-tracking" },
    emptyState: {
