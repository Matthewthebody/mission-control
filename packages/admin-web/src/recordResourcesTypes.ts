import type { ResourceLibraryCategory, ResourceLibraryType } from "./types";
...
export type RecordResourceLinkedObject = {
  object_type: "organization" | "location" | "shoot" | "job" | "production_item";
  object_id: string;
};

export type RecordResourceItem = {
  id: string;
  title: string;
...
export type RecordResourcesResponse = {
  object: {
...
export type CreateRecordResourceInput = {
  title: string;
  category: ResourceLibraryCategory;
  description?: string | null;
