...
export type ProjectWorkflowHealthState = "green" | "yellow" | "red";
...
export type ProjectWorkflowMilestone = {
  id: string;
  milestone_key: string;
  name: string;
  description: string | null;
...
export type ProjectWorkflowHandoff = {
  id: string;
  workflow_run_id: string;
...
export type ProjectWorkflowInstance = {
  workflow_run: {
    id: string;
    job_id: string;
    template_id: string;
  ...
  handoffs: ProjectWorkflowHandoff[];
  audit_events: ProjectWorkflowAuditEvent[];
};

export type ProjectWorkflowTemplateSummary = {
  id: string;
  template_key: string;
  name: string;
  description: string | null;
...
export type ProjectWorkflowCommandCenter = {
  ...
  steps: Array<ProjectWorkflowStep & { job_title: string; organization_name: string | null }>;
...
export type ProjectWorkflowJobRow = {
  ...
  current_step: (ProjectWorkflowStep & { phase: string }) | null;
  phase: string;
...
export type WorkflowTemplateBuilderStep = {
  id: string;
  step_key: string;
  name: string;
  description: string | null;
...
export type WorkflowTemplateBuilderMilestone = {
  id: string;
  milestone_key: string;
  name: string;
  description: string | null;
  ...
  steps: WorkflowTemplateBuilderStep[];
};
...
export type WorkflowTemplateBuilderDetail = {
  ...
  milestones: WorkflowTemplateBuilderMilestone[];
};

export type WorkflowTemplateBuilderSummary = {
  id: string;
  template_key: string;
  name: string;
  description: string | null;
  ...
  status: "active" | "archived";
  updated_at: string;
  latest_version: WorkflowTemplateBuilderDetail["version"] | null;
};
