...
const ROUTES: RouteDefinition[] = [
  ...
  },
  {
    ...
    label: "Staffing",
    sectionKey: "schedule",
    description: "Coverage gaps, staffing control, and lead assignment inside the schedule workspace.",
  ...
  },
  {
    ...
    label: "Readiness",
    sectionKey: "photography",
    description: "Field readiness, pre-service completion, staffing confidence, and launch pressure before a shoot goes live.",
  ...
  },
  {
    ...
    label: "Photography",
    sectionKey: "photography",
    description: "Department workspace for studio and field execution, readiness, staffing, travel logistics, pre-service, and workload clarity.",
  ...
  },
  {
    ...
    label: "Staffing",
    sectionKey: "photography",
    description: "Studios staffing view into the shared scheduling engine for photographer placement and open coverage.",
  ...
  },
  {
    ...
    label: "Calendar",
    sectionKey: "photography",
    description: "Calendar-first studios view over the shared master schedule.",
...
const SECTION_CHILD_ORDER: Partial<Record<ShellSectionKey, ShellRouteId[]>> = {
  ...
  schedule: ["operations-schedule", "operations-scheduling", "operations-staffing"],
  "hr-admin": [
    "people-ops",
