...
const ROUTES: RouteDefinition[] = [
  ...
  },
  {
    ...
    sectionKey: "photography",
    description: "Compatibility route that opens Job Prep with readiness context, not a separate workflow.",
  ...
  },
  {
    ...
    label: "Photography",
    sectionKey: "photography",
    description: "Today-first field command surface for shoot timing, locations, readiness, travel, Job Prep, and senior review clarity.",
  ...
  },
  {
    ...
    label: "Senior Review",
    sectionKey: "photography",
    description: "Compact senior review view for readiness trends, evaluation highlights, feedback, and coaching opportunities.",
